...
const comparisonUsabilitySchools = [
  {
    ...
    profileUrl:
      "/user-research/comparison-usability/school-profiles/oak-nest/about-the-school",
  },
  {
    id: "thomas-lane",
    ...
    profileUrl:
      "/user-research/comparison-usability/school-profiles/thomas-lane/about-the-school",
  },
  {
    id: "langley-hill",
    ...
    profileUrl:
      "/user-research/comparison-usability/school-profiles/langley-hill/about-the-school",
  },
];

router.get(
  "/user-research/comparison-usability/my-schools-list",
...
router.get("/pupil-characteristic", function (req, res) {
  ...
  res.render(
    "prototype-v-1/academic-performance/attainment/attainment-versions/attainment",
    {
      characteristic,
      subject,
    },
...
router.get(
  "/prototype-v-1/academic-performance/attainment-v-3",
  function (req, res) {
...
router.post("/add-school", function (req, res) {
  ...
  if (schoolId === "school-1") {
    ...
    req.session.data["school-1-address"] = "Baltic Campus, Quarryfield Road";
  }

  if (schoolId === "school-2") {
    req.session.data["school-2-name"] = "Langley Secondary School";
    req.session.data["school-2-address"] = "Prince Road, Thistle Hill";
  }

  if (schoolId === "school-3") {
    req.session.data["school-3-name"] = "Thomas Lane Secondary School";
    req.session.data["school-3-address"] = "10 St. James Street, Kingley Park";
  }
...
router.get(
  "/user-research/comparison-usability/compare-schools",
  function (req, res) {
    const selectedIds = req.session.data["selected-schools"] || [];

    const selectedSchools = comparisonUsabilitySchools.filter(
      function (school) {
